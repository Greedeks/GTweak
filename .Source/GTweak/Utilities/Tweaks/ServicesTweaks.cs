        ...
        public ServicesTweaks()
        {
            _tglTweaks = new Dictionary<ServiceToggle, (Func<bool> Check, Action<bool> Apply)>
            {
                [ServiceToggle.WindowsSearch] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WSearch", "Start", "4") ||
                ...
                [ServiceToggle.Xbox] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\XboxGipSvc", "Start", "4") ||
                ...
                [ServiceToggle.WindowsUpdate] = (
                    Check: () => PathLocator.Targets.WindowsUpdate.Mappings.All(f => File.Exists(f.Normal)),
                    Apply: (state) =>
                    {
                ...
                [ServiceToggle.WindowsStore] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WalletService", "Start", "4") ||
                ...
                [ServiceToggle.PerformanceCounters] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\wmiApSrv", "Start", "4") ||
                ...
                [ServiceToggle.Biometrics] = (
                    Check: () => RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WbioSrvc", "Start", "4"),
                    Apply: (state) =>
                    {
                ...
                [ServiceToggle.Bluetooth] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\bthserv", "Start", "4") ||
                ...
                [ServiceToggle.Printers] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Spooler", "Start", "4") ||
                ...
                [ServiceToggle.Scanner] = (
                    Check: () => RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WiaRpc", "Start", "4"),
                    Apply: (state) => RegistryHelp.Write(Registry.LocalMachine, @"SYSTEM\CurrentControlSet\Services\WiaRpc", "Start", state ? 3 : 4, RegistryValueKind.DWord)
                ),

                [ServiceToggle.Fax] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TapiSrv", "Start", "4") ||
                ...
                [ServiceToggle.TabletMobileMode] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SensrSvc", "Start", "4") ||
                ...
                [ServiceToggle.SecondaryMonitors] = (
                    Check: () => RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WFDSConMgrSvc", "Start", "4"),
                    Apply: (state) => RegistryHelp.Write(Registry.LocalMachine, @"SYSTEM\CurrentControlSet\Services\WFDSConMgrSvc", "Start", state ? 3 : 4, RegistryValueKind.DWord)
                ),

                [ServiceToggle.SystemComponents] = (
                    Check: () => RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\CDPSvc", "Start", "4"),
                    Apply: (state) =>
                    {
                ...
                [ServiceToggle.LocalNetwork] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Netlogon", "Start", "4") ||
                ...
                [ServiceToggle.UsbModemsRouters] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WwanSvc", "Start", "4") ||
                ...
                [ServiceToggle.VpnClients] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\PolicyAgent", "Start", "4") ||
                ...
                [ServiceToggle.WindowsMedia] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WPDBusEnum", "Start", "4") ||
                ...
                [ServiceToggle.RemoteDesktop] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\UmRdpService", "Start", "4") ||
                ...
                [ServiceToggle.ErrorEventLogging] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WerSvc", "Start", "4") ||
                ...
                [ServiceToggle.WebDav] = (
                    Check: () => RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WebClient", "Start", "4"),
                    Apply: (state) => RegistryHelp.Write(Registry.LocalMachine, @"SYSTEM\CurrentControlSet\Services\WebClient", "Start", state ? 3 : 4, RegistryValueKind.DWord)
                ),

                [ServiceToggle.SmartCards] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SCPolicySvc", "Start", "4") ||
                ...
                [ServiceToggle.WindowsKiosk] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\AssignedAccessManagerSvc", "Start", "4") ||
                ...
                [ServiceToggle.FileEncryption] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\BDESVC", "Start", "4") ||
                ...
                [ServiceToggle.WindowsLocalization] = (
                    Check: () => RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\LxpSvc", "Start", "4"),
                    Apply: (state) => RegistryHelp.Write(Registry.LocalMachine, @"SYSTEM\CurrentControlSet\Services\LxpSvc", "Start", state ? 3 : 4, RegistryValueKind.DWord)
                ),

                [ServiceToggle.BackgroundSecurityCheck] = (
                    Check: () => RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WarpJITSvc", "Start", "4"),
                    Apply: (state) => RegistryHelp.Write(Registry.LocalMachine, @"SYSTEM\CurrentControlSet\Services\WarpJITSvc", "Start", state ? 3 : 4, RegistryValueKind.DWord)
                ),

                [ServiceToggle.BackgroundDiagnostics] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WdiSystemHost", "Start", "4") ||
                ...
                [ServiceToggle.CorporateTools] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\workfolderssvc", "Start", "4") ||
                ...
                [ServiceToggle.HyperV] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\vmicvmsession", "Start", "4") ||
                ...
                [ServiceToggle.PushNotifications] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\PushToInstall", "Start", "4") ||
                ...
                [ServiceToggle.RetailDemo] = (
                    Check: () => RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\RetailDemo", "Start", "4"),
                    Apply: (state) =>
                    {
                ...
                [ServiceToggle.EdgeUpdates] = (
                    Check: () =>
                    {
                        return RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\edgeupdate", "Start", "4") ||
                ...
                [ServiceToggle.MultimediaClassScheduler] = (
                    Check: () => RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\MMCSS", "Start", "4"),
                    Apply: (state) => RegistryHelp.Write(Registry.LocalMachine, @"SYSTEM\CurrentControlSet\Services\MMCSS", "Start", state ? 3 : 4, RegistryValueKind.DWord, true)
                ),

                [ServiceToggle.Geolocation] = (
                    Check: () => RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\lfsvc", "Start", "4") || IsTaskEnabled(geoTasks),
                    Apply: (state) =>
                    {
