    ...
    internal sealed class SystemTweaks : FirewallManager
    {
        ...
        internal void AnalyzeAndUpdate()
        {
            ...
            _сontrolWriter.Button[29] =
                RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU", "NoAutoUpdate", "1", false) ||
                RegistryHelp.CheckValue(@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU", "AUOptions", "1", false);
        ...
        internal async void ApplyTweaks(string tweak, bool isDisabled, bool canShowWindow = true)
        {
            ...
            switch (tweak)
            {
                ...
                case "TglButton9":
                    ...
                    RegistryHelp.Write(Registry.LocalMachine, @"SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FlyoutMenuSetting", "ShowHibernateOption", isDisabled ? 0 : 1, RegistryValueKind.DWord);
