...
namespace GTweak.Utilities.Helpers.Storage
{
    ...
    {
        internal static readonly Dictionary<string, string> GetConfActions = new[]
        {
            new { Button = "TglButton8", Action = "restart" },
            new { Button = "TglButton15", Action = "restart" }
        }.ToDictionary(x => x.Button, x => x.Action);

        internal static readonly Dictionary<string, string> GetIntfActions = new[]
        {
        ...
        internal static readonly Dictionary<string, string> GetSysActions = new[]
        {
            new { Button = "TglButton2", Action = "logout" },
